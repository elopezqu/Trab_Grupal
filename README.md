...
<table>
 ...
 <tbody>
  ...
  <tr><td><strong>II. SOLUCIÓN DEL CUESTIONARIO:</strong><br>¿Por qué Git y Github son herramientas importantes para el curso?<br>El Git y el GitHub son herramientas de vital importancia no solo para el curso, sino para toda nuestra vida como programadores, esto debido a que nos permite trabajar en grupo, de manera simultanea, ordenada y sobre todo eficiente. Por otro lado tambien cuenta con un gran sistema de control de versiones lo que hace que sea la herramienta ideal para curso y nuestros futuros proyectos(que obviamente serán con algún grupo de trabajo).<br>¿Qué conductas éticas deberían promocionarse cuando se usa un Sistema de Control de Versiones?<br>Siempre hacer commits de los cambios por más minimos que sean, cuando se trabaja en equipo uno debe ser quien una las ramas, asi como comunicar de cambios realizados<br>¿Qué son los entándares de codificación?<br>Son practicas de programación que todo programador debe conocer, como por ejemplo la identación o saber comentar</td></tr>
  <tr><td><strong>III. CONCLUSIONES:</strong><br>- La sobrecarga de metodos nos ayudan para preservar la compatibilidad con versiones anteriores <br>- Java es un lenguaje muy facil de aprender y te da la facilidad de aprender otros lenguajes muy rapido</td></tr>
 </tbody>
</table>
